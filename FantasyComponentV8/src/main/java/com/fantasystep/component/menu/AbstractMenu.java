...
public abstract class AbstractMenu extends ContextMenu implements ContextMenu.ContextMenuOpenListener
{
	...
	protected final Map<MenuItem,MenuEvent>	itemsMap	= new HashMap<MenuItem,MenuEvent>();
	protected MenuHelper							menuHelper;

	public AbstractMenu(AbstractComponent parentComponent, MenuHelper menuHelper )
	{
		super(parentComponent, true);
		this.menuHelper = menuHelper;
//		this.addContextMenuOpenListener(this);
...
//		this.addItemClickListener( this );
	...
	private @SuppressWarnings("serial")
		...
		public void menuSelected(MenuItem selectedItem) {
			MenuEvent e = itemsMap.get( selectedItem );
			if(selectedItem.hasChildren())
				return;
			AbstractMenu.this.removeItems();
			handleMenuAction( e );
		}
	};
	
	protected MenuItem addMenuItem( MenuAction menuAction, Class<? extends Node> clazz, MenuItem parentItem )
	{
		MenuItem item = null;
		String caption = "";
...
//		if(MenuAction.INSERT.getLabel().equals(item.getData()) || MenuAction.IMPORT.getLabel().equals(item.getData()) || e == null )
	...
	protected abstract void onItemRendering( MenuItem item, MenuAction menuAction );

	protected void setEnabledItems( boolean enabled )
	{
		for( MenuItem item : itemsMap.keySet() )
	...
	public void showMenu( int posX, int posY, boolean hasHideFunc, boolean onlyDeleteCheck )
	{
		...
		{
			MenuItem createMenuItem = addMenuItem( MenuAction.INSERT, fcl, null );
		...
		{
			MenuItem updateItem = addMenuItem( MenuAction.UPDATE, fcl, null );
