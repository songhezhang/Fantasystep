...
public class DoLock extends AbstractMethod {
    ...
    private void doLock(ITransaction transaction, HttpServletRequest req,
        ...
        StoredObject so = _store.getStoredObject(transaction, _path,false);
    ...
    private void doNullResourceLock(ITransaction transaction,
        ...
        try {
            parentSo = _store.getStoredObject(transaction, _parentPath,false);
            ...
            nullSo = _store.getStoredObject(transaction, _path, false);
            if (nullSo == null) {
