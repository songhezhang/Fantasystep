...
public class AccountTableCContainer extends AbstractTableCContainer
{
	...
	protected Table getNodeTable()
	{
		if( this.nodeTable == null )
		{
			...
			AbstractMenu menu = new NodeMenu(this.nodeTable, (AccountMenuTable) this.nodeTable )
			{
				@Override
				...
				public void showMenu( int posX, int posY )
				{
					...
					{
						MenuItem updateItem = addMenuItem( MenuAction.UPDATE, firstNode.getClass(), null );
